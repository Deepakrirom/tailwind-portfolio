            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                <div className='flex-1'>
                    ...
                    <div className='mb-4 mt-8'>
                        ...
                        <a href="deepakirom171@gmail.com" className='hover:underline'>
                        deepakirom171@gmail.com
                        </a>
                    </div>
                    <div className='mb-4'>
                        <FaPhone className='inline-block text-green-400 mr-2'></FaPhone>

                        <span>+919863048743</span>
                    </div>
                    <div className='mb-4 '>
                        <FaMapMarkedAlt className='inline-block text-green-400 mr-2'></FaMapMarkedAlt>
                        <span>MANIPUR , IMPHAL</span>
                    </div>
                </div>
                <div className='flex-1 w-full'>
                    <form className='space-y-4'>
                        ...
                        <button className='bg-gradient-to-r from-green-400 to-blue-500  md:inline transform transition-transform duration-300 hover:scale-105 px-8 py-2 rounded-full'>Send</button>
                    </form>
                </div>
            </div>
        </div>
